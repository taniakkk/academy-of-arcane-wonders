(() => {
    ...
    function headerScroll() {
        ...
        document.addEventListener("windowScroll", (function(e) {
            ...
            } else header.classList.contains("_header-scroll") ? header.classList.remove("_header-scroll") : null;
    ...
    if (!isMobile.any()) document.addEventListener("mousemove", (e => {
        const numSparkles = Math.floor(Math.random() * 10) + 20;
        const sparkles = [];
        for (let i = 0; i < numSparkles; i++) {
            ...
            sparkle.style.left = `${Math.min(Math.max(e.pageX + offsetX, 0), maxX)}px`;
